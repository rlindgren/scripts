...
var app = {
	app: 'app',
		lib: $(app.app, 'lib',
		src: $(app.app, 'src'),
			initSrc: $(app.src, 'init'),
			configSrc: $(app.src, 'config'),
			constantsSrc: $(app.src, 'constants'),
			globalsSrc: $(app.src, 'globals'),
			mocksSrc: $(app.app, 'mocks'),
			utilsSrc: $(app.src, 'utils'),
				filtersSrc: $(app.utils, 'filters'),
				directivesSrc: $(app.utilsSrc, 'directives'),
				animationsSrc: $(app.utilsSrc, 'animations'),
			appframeSrc: $(app.src, 'appframe'),
				contentSrc: $(app.appframeSrc, 'content'),
				footerSrc: $(app.appframeSrc, 'footer'),
				headerSrc: $(app.appframeSrc, 'header'),
				menuSrc: $(app.appframeSrc, 'menu'),
				navigationSrc: $(app.appframeSrc, 'navigation'),
				notificationsSrc: $(app.appframeSrc, 'notifications'),
			modulesSrc: $(app.src, 'modules'),
				accountantSrc: $(app.modulesSrc, 'accountant'),
				billsViews: $(app.modulesSrc, 'bills'),
				contractsViews: $(app.modulesSrc, 'contracts'),
				dashboardSrc: $(app.modulesSrc, 'dashboard'),
				departmentsSrc: $(app.modulesSrc, 'departments'),
				entitiesSrc: $(app.modulesSrc, 'entities'),
					clientsSrc: $(app.entitiesSrc, 'clients'),
					vendorsSrc: $(app.entitiesSrc, 'vendors'),
				invoicesSrc: $(app.modulesSrc, 'invoices'),
				paymentsSrc: $(app.modulesSrc, 'payments'),
				projectsSrc: $(app.modulesSrc, 'projects'),
				requestsSrc: $(app.modulesSrc, 'requests'),
				resourcesSrc: $(app.modulesSrc, 'resources'),
				tenantsSrc: $(app.modulesSrc, 'tenants'),
					adminSrc: $(app.tenantsSrc, 'admin'),
					setupSrc: $(app.tenantsSrc, 'setup'),
				timesheetsSrc: $(app.modulesSrc, 'timesheets'),
			dataSrc: $(app.src, 'data'),
				httpSrc: $(app.dataSrc, 'http'),
				socketSrc: $(app.dataSrc, 'socket'),
			systemSrc: $(app.src, 'system'),
				indexingSrc: $(app.systemSrc, 'indexing'),
				emailsSrc: $(app.systemsSrc, 'emails'),
				errorsSrc: $(app.systemsSrc, 'errors'),
				quickbooksSrc: $(app.systemsSrc, 'quickbooks'),
				debugSrc: $(app.systemsSrc, 'debug'),
			verificationSrc: $(app.src, 'verification'),
				authenticationSrc: $(app.verificationSrc, 'authentication'),
				validationSrc: $(app.verificationSrc, 'validation'),
				privilegesSrc: $(app.verificationSrc, 'privileges'),
		styles: $(app.app, 'styles'),
			fonts: $(app.styles, 'webfonts'),
			stylesLib: $(app.fonts, 'lib')
		views: $(app.app, 'views'),
			modalViews: $(app.views, 'modals'),
			appframeViews: $(app.views, 'appframe'),
			moduleViews: $(app.views, 'modules'),
				accountantViews: $(app.modulesViews, 'accountant'),
				billsViews: $(app.modulesViews, 'bills'),
				contractsViews: $(app.modulesViews, 'contracts'),
				dashboardViews: $(app.modulesViews, 'dashboard'),
				departmentsViews: $(app.modulesViews, 'departments'),
				entitiesViews: $(app.modulesViews, 'entities'),
					clientsViews: $(app.entities, 'clients'),
					vendorsViews: $(app.entities, 'vendors'),
				invoicesViews: $(app.modulesViews, 'invoices'),
				paymentsViews: $(app.modulesViews, 'payments'),
				projectsViews: $(app.modulesViews, 'projects'),
				requestsViews: $(app.modulesViews, 'requests'),
				resourcesViews: $(app.modulesViews, 'resources'),
				tenantsViews: $(app.modulesViews, 'tenants'),
					adminViews: $(app.tenants, 'admin'),
					setupViews: $(app.tenants, 'setup'),
				timesheetsViews: $(app.modulesViews, 'timesheets'),
			systemViews: $(app.views, 'system'),
				errorViews: $(app.systemViews, 'error'),
				indexingViews: $(app.systemViews, 'indexing'),
				emailsViews: $(app.systemViews, 'emails'),
				quickbooksViews: $(app.systemViews, 'quickbooks'),
				debugViews: $(app.systemsViews, 'debug'),
			authenticationViews: $(app.views, 'authentication'),
		test: 'test',
		e2e: $(app.test, 'e2e'),
		spec: $(app.test, 'spec'),
